...
<%
   ...
   try {
      ...
      String sql = "INSERT INTO employee (name, father_name, mother_name, email, gender, password, address, city, zip_code, phone_no, courses) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      ...
      response.sendRedirect("addsucess.jsp"); // Redirect to a success page
   } catch (Exception e) {
      e.printStackTrace();
